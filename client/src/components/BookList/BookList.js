    ...
    return (
      <div className="mb-4 " key={index}>
        <div className="card bookCards">
          <div>
            <img className="thumbnail my-3" src={item.image} alt="thumb"></img>
          </div>
          ...
          <div className="card-body text-center">
            <div className="text-center">
              <div>
                <a
                  href={item.link}
                  className="btn btn-outline-primary m-2 bookLink"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <i className="fa fa-rocket"></i> Link to the book
                </a>
              </div>
              <div>
                <button
                  ...
                  data={item}
                >
                  <i className="fa fa-list "></i> Save book to my list
                </button>
              </div>
            </div>
          </div>
